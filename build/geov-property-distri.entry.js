...
const geovPropertyDistriCss = ":host{display:block}.loading{display:flex;align-items:center;justify-content:center;background-color:var(--ion-color-light-tint, #fafafa)}";
...
`;
const GeovPropertyDistri = class {
  constructor(hostRef) {
...
GeovPropertyDistri.style = geovPropertyDistriCss;

export { GeovPropertyDistri as geov_property_distri };

//# sourceMappingURL=geov-property-distri.entry.js.map